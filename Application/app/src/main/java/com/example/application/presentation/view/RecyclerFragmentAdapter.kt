...
class RecyclerFragmentAdapter(
    ...
    RecyclerView.Adapter<RecyclerFragmentAdapter.CategoryViewHolder>() {

    private val items: ArrayList<CategoryWithStatus> = arrayListOf()
    ...
    fun submitUpdate(update: List<CategoryWithStatus>) {
        val callback = CategoriesDiffCallback(items, update)
